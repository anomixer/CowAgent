...
| `_teamAiLoadingEl` | Observer 端的 AI thinking spinner DOM 元素 |
...
| `db.get_user_conversation_sessions` | SQL 過濾 `team_session_*` |
| `conversation_store.list_sessions` | SQL 過濾 `team_*` |
...
> **Branch**: `feat-multiuser`  \
> **Status**: Phase 1 ✅ + Phase 2 ✅ + Phase 3 ✅ + Phase 3.5 ✅ (團聊 IM 即時訊息系統完成) 🎉
